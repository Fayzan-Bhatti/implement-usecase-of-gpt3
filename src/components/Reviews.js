...
class Reviews extends Component {
  ...
  onFormSubmit = e => {
    ...
    openai.createCompletion("text-davinci-002", {
      prompt: `translate this in ${formDataObj.language}. Create ${formDataObj.tone} reply for the following message:  ${formDataObj.productName} and ${formDataObj.productDescription}`,
      temperature: 0.8,
      max_tokens: 100,
      top_p: 1,
      frequency_penalty: 0,
              ...
              <div className=''>
                ...
                <Form.Group className="mb-3" controlId="formBasicEmail">
                  ...
                  <Form.Control
                    ...
                    placeholder="Best AI writer and copywriting assistant in the market" />
                  <Form.Text className="text-muted">
                    Enter as much information as possible for more acurate descriptions.
                  </Form.Text>
                </Form.Group>
