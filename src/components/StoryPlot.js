...
class StoryPlot extends Component {
  constructor() {
    super()
    this.state = {
  ...
  onFormSubmit = e => {
    ...
    openai.createCompletion("text-davinci-002", {
      prompt: `translate this in ${formDataObj.language}. Create ${formDataObj.tone} story plot for the following story idea: ${formDataObj.productName}`,
      temperature: 0.8,
      max_tokens: 100,
      top_p: 1,
      frequency_penalty: 0,
              ...
              <div className=''>
                ...
                <Form.Group className="mb-3" controlId="formBasicEmail">
                  ...
                  <Form.Control
                    type="text"
                    name="productName"
                    placeholder="The time when I could not distinguish AI from humans" />
