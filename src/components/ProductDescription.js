...
class ProductDescription extends Component {
  ...
  onFormSubmit = e => {
    ...
    openai.createCompletion("text-davinci-002", {
      prompt: `translate this in ${formDataObj.language}. Create ${formDataObj.tone} product description for ${formDataObj.keywords} described as ${formDataObj.productName}`,
      temperature: 0.8,
      max_tokens: 100,
      top_p: 1,
      frequency_penalty: 0,
