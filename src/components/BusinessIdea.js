...
class BusinessIdea extends Component {
  constructor() {
    super()
    this.state = {
  ...
  onFormSubmit = e => {
    ...
    openai.createCompletion("text-davinci-002", {
      prompt: ` translate this in ${formDataObj.language}. Brainstorm ${formDataObj.tone} business idea where interest is ${formDataObj.productName} and skills are ${formDataObj.productDescription}`,
      temperature: 0.8,
      max_tokens: 100,
      top_p: 1,
      frequency_penalty: 0,
      ...
      .then((response) => {
        this.setState({
          heading: `AI Response: ${formDataObj.productName}`,
              ...
              <div className=''>
                ...
                <Form.Group className="mb-3" controlId="formBasicEmail">
                  ...
                  <Form.Control
                    ...
                    placeholder="copywriting, marketing, product development, AI" />
                  <Form.Text className="text-muted">
                    Enter as much information as possible for more acurate descriptions.
                  </Form.Text>
                </Form.Group>
