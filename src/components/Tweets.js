...
class Tweets extends Component {
  ...
  onFormSubmit = e => {
    ...
    openai.createCompletion("text-davinci-002", {
      prompt: `translate this in ${formDataObj.language}. Create ${formDataObj.tone} a detailed, smart, informative and professional tweet of: ${formDataObj.tweet}`,
      temperature: 0.8,
      max_tokens: 100,
      top_p: 1,
      frequency_penalty: 0,
      ...
      .then((response) => {
        this.setState({
          heading: `AI Response of: ${formDataObj.tweet}`,
            ...
            <div className='container'>
              ...
              <div className=''>
                ...
                <Form.Group className="mb-3" controlId="formBasicEmail">
                  <Form.Label>What Product Would You like to tweet about?</Form.Label>
                  <Form.Control
                    type="text"
                    name="tweet"
                    placeholder="Write Somethig for generating Tweets " />
