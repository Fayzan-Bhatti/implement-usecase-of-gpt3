...
class VideoIdea extends Component {
  constructor() {
    super()
    this.state = {
  ...
  onFormSubmit = e => {
    ...
    openai.createCompletion("text-davinci-002", {
      prompt: `translate this in ${formDataObj.language}. Brainstorm ${formDataObj.tone} video idea for the following keywords: ${formDataObj.productName}`,
      temperature: 0.8,
      max_tokens: 100,
      top_p: 1,
      frequency_penalty: 0,
              ...
              <div className=''>
                ...
                <Form.Group className="mb-3" controlId="formBasicEmail">
                  ...
                  <Form.Control
                    type="text"
                    name="productName"
                    placeholder="AI Writting assistant" />
