...
class VideoDescription extends Component {
  ...
  onFormSubmit = e => {
    ...
    openai.createCompletion("text-davinci-002", {
      prompt: `translate this in ${formDataObj.language}. Create ${formDataObj.tone} video description for the following video title: ${formDataObj.productName}`,
      temperature: 0.8,
      max_tokens: 100,
      top_p: 1,
      frequency_penalty: 0,
              ...
              <div className=''>
                ...
                <Form.Group className="mb-3" controlId="formBasicEmail">
                  ...
                  <Form.Control
                    type="text"
                    name="productName"
                    placeholder="How to Use AI Writers to Create High-Quality Blogs in Minutes" />
