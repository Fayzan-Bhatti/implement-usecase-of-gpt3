...
class AdsforSocialMedia extends Component {
  constructor() {
    super()
    this.state = {
  ...
  onFormSubmit = e => {
    ...
    openai.createCompletion("text-davinci-002", {
      prompt: `translate this in ${formDataObj.language}. Create ${formDataObj.tone} ad to run on Facebook for the following product description: ${formDataObj.productName} and product description: ${formDataObj.productDescription}`,
      temperature: 0.8,
      max_tokens: 100,
      top_p: 1,
      frequency_penalty: 0,
...
export default AdsforSocialMedia
