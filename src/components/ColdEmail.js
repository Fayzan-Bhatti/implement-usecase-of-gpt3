...
class ColdEmail extends Component {
  ...
  onFormSubmit = e => {
    ...
    openai.createCompletion("text-davinci-002", {
      prompt: `translate this in ${formDataObj.language}. Create ${formDataObj.tone} email where key points are: ${formDataObj.email}`,
      temperature: 0.8,
      max_tokens: 250,
      top_p: 1,
      frequency_penalty: 0,
      ...
      .then((response) => {
        this.setState({
          heading: `AI Response of: ${formDataObj.email}`,
